...
set DPU_IP_PATH ../../ips/DPUCZDX8G_ip_repo_VAI_v3.0
...
set_property ip_repo_paths $DPU_IP_PATH [current_project]
update_ip_catalog
...
set ps_reset_600M [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 ps_reset_600M ]
...
set clk_600M [get_bd_pins clk_wiz_0/clk_600M]
...
# ps_reset_600M
set rst_600M [get_bd_pins ps_reset_600M/peripheral_reset]
set rstn_600M [get_bd_pins ps_reset_600M/peripheral_aresetn]
connect_bd_net [get_bd_pins ps_reset_600M/slowest_sync_clk] $clk_600M
connect_bd_net $pl_resetn0 [get_bd_pins ps_reset_600M/ext_reset_in]
...
connect_bd_intf_net [get_bd_intf_pins axi_interc_hpm0/M00_AXI] [get_bd_intf_pins axi_intc_0/s_axi]
...
if {$EXTENSIBLE_PLATFORM} {
    ...
    set_property PFM.AXI_PORT { \
        M01_AXI {memport "M_AXI_GP" sptag "" memory "" is_range "true"} \
        M02_AXI {memport "M_AXI_GP" sptag "" memory "" is_range "true"} \
        M03_AXI {memport "M_AXI_GP" sptag "" memory "" is_range "true"} \
        M04_AXI {memport "M_AXI_GP" sptag "" memory "" is_range "true"} \
        M05_AXI {memport "M_AXI_GP" sptag "" memory "" is_range "true"} \
        M06_AXI {memport "M_AXI_GP" sptag "" memory "" is_range "true"} \
        M07_AXI {memport "M_AXI_GP" sptag "" memory "" is_range "true"} \
    } [get_bd_cells /axi_interc_hpm0]

    # set_property PFM.CLOCK {} [get_bd_cells /zynq_ultra_ps]
    set_property PFM.CLOCK { \
        clk_300M {id "1" is_default "true" proc_sys_reset "/ps_reset_300M" status "fixed" freq_hz "299997000"} \
        clk_600M {id "2" is_default "false" proc_sys_reset "/ps_reset_600M" status "fixed" freq_hz "599994000"} \
    } [get_bd_cells /clk_wiz_0]
